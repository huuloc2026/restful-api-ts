import { UserAdvanceService } from 'services/UserAdvance.services';
import responseHandler from 'utils/ResponseHandler';
const userAdvanceService = new UserAdvanceService();
class UserAdvanceController {
    // Tạo mới UserAdvance
    static createUserAdvance = async (req, res, next) => {
    ...
    static getUserAdvances = async (req, res, next) => {
        try {
    ...
    static getUserAdvanceByUserId = async (req, res, next) => {
    ...
    static updateUserAdvance = async (req, res, next) => {
        const userId = parseInt(req.params.userId);
    ...
    // Xóa UserAdvance
    static deleteUserAdvance = async (req, res, next) => {
        const userId = parseInt(req.params.userId);
        if (isNaN(userId)) {
            responseHandler.error(res, 400, 'Validation Error', 'Invalid userId');
        }
...
//# sourceMappingURL=UserAdvance.controllers.js.map